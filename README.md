...
Unfortunately one thing the Tailscale client doesn't do is provide the ability to update your clients automatically (that may be quite numerous) and that it what this little project is attempting to tackle, on Windows at least.
